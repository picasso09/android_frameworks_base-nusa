...
import android.provider.Settings.System.MEDIA_ARTWORK_FORCE_EXPAND
    ...
    private inner class SettingsObserver(
        ...
        fun observe() {
            handler.post {
                val newSettings = ArtworkSettings(
                    ...
                    forceExpand = systemSettings.getIntForUser(
                        MEDIA_ARTWORK_FORCE_EXPAND, 0, USER_CURRENT) == 1,
            ...
            systemSettings.registerContentObserverForUser(
                MEDIA_ARTWORK_FORCE_EXPAND, this, USER_ALL)
            systemSettings.registerContentObserverForUser(
        ...
        override fun onChange(selfChange: Boolean, uri: Uri) {
            val newSettings = when (uri.lastPathSegment) {
                ...
                MEDIA_ARTWORK_FORCE_EXPAND -> artworkSettings.copy(
                    enabled = systemSettings.getIntForUser(
                        MEDIA_ARTWORK_FORCE_EXPAND, 0, USER_CURRENT) == 1
                )
