...
import static com.nusantara.systemui.Dependency.*;
...
public abstract class NusantaraSystemUIModule {
    ...
    @Binds
    abstract ThemeOverlayController provideThemeOverlayController(NusantaraThemeOverlayController themeOverlayController);
