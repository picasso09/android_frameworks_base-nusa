package com.nusantara.systemui.keyguard;
...
public class NusantaraKeyguardSliceProvider extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    private static final String TAG = "NusantaraKeyguardSliceProvider";
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<NusantaraKeyguardSliceProvider> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(NusantaraKeyguardSliceProvider nusantaraKeyguardSliceProvider, SmartSpaceCard smartSpaceCard) {
            this.mProviderReference = new WeakReference<>(nusantaraKeyguardSliceProvider);
            this.mWeatherCard = smartSpaceCard;
            this.mBlurRadius = nusantaraKeyguardSliceProvider.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            NusantaraKeyguardSliceProvider nusantaraKeyguardSliceProvider;
            synchronized (this) {
                this.mWeatherCard.setIcon(bitmap);
                nusantaraKeyguardSliceProvider = this.mProviderReference.get();
            }
            if (nusantaraKeyguardSliceProvider != null) {
                nusantaraKeyguardSliceProvider.notifyChange();
            }
        }
