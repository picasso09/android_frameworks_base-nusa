...
public class NusantaraKeyguardSliceProvider extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        AddShadowTask(NusantaraKeyguardSliceProvider keyguardSliceProvider, SmartSpaceCard smartSpaceCard) {
        ...
        public void onPostExecute(Bitmap bitmap) {
            NusantaraKeyguardSliceProvider keyguardSliceProvider;
            synchronized (this) {
                mWeatherCard.setIcon(bitmap);
                keyguardSliceProvider = (NusantaraKeyguardSliceProvider) mProviderReference.get();
            }
    ...
    public Slice onBindSlice(Uri uri) {
        Trace.beginSection("NusantaraKeyguardSliceProvider#onBindSlice");
        Slice slice;
