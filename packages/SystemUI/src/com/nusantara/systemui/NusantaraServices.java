...
@SysUISingleton
public class NusantaraServices extends VendorServices {
    ...
    @Inject
    public NusantaraServices(Context context, UiEventLogger uiEventLogger, Lazy<ServiceConfigurationGoogle> serviceConfigurationGoogle, Lazy<ColumbusServiceWrapper> columbusService) {
        super(context);
